...
export const site = {
  // TODO: replace with your real production domain once deployed -- this powers
  // canonical URLs, the sitemap, robots.txt, and Open Graph image resolution.
  ...
  about: {
    ...
    body: `I'm a BSCS graduate (NUTECH '25) working as an AI Automation Engineer at HashDev Solutions. I previously worked as an On-Device AI Engineer at CloudGate Technologies, and I'm also Co-Founder & COO at SHS Creators.
