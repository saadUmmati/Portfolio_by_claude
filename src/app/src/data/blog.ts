...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "on-device-clustering-with-dinov2",
    title: "Building On-Device Photo Clustering with DINOv2",
    excerpt:
      "How I used a quantized DINOv2-small ONNX model to cluster gallery photos entirely on-device, and what broke along the way.",
    date: "June 2026",
    readTime: "6 min",
    tags: ["On-Device AI", "Android", "ONNX"],
    content: [
      p(
        "This is placeholder content. Replace it with your real write-up about building ClipGallery's on-device clustering pipeline."
      ),
      p(
        "Cover the DINOv2-small ONNX INT8 setup, the move from single-linkage to average-linkage clustering, and how you fixed the null centroid persistence bug."
      ),
    ],
  },
  {
    slug: "why-i-moved-to-on-device-ai",
    title: "Why I Moved from Cloud AI to On-Device AI",
    excerpt:
      "The trade-offs I found between server-side inference and running models directly on Android devices.",
    date: "May 2026",
    readTime: "4 min",
    tags: ["Career", "On-Device AI"],
    content: [
      p(
        "This is placeholder content. Replace it with your own perspective on cloud vs. on-device AI trade-offs."
      ),
    ],
  },
];
