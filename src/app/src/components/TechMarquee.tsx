              ...
              >
                {[...longRow, ...longRow].map((item, j) => (
                  <div
                    key={`${item.label}-${j}`}
                    title={item.label}
                    className="flex h-32 w-32 shrink-0 items-center justify-center rounded-2xl border border-border bg-surface transition-transform duration-300 hover:z-10 hover:scale-125 hover:border-accent"
                  >
