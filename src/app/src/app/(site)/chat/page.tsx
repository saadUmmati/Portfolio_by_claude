...
export default function ChatPage() {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      content: `Hi! I'm ${site.name}'s AI assistant. Ask me anything about his work, services, or expertise.`,
    },
  ]);
  ...
  return (
    <div className="container-page flex flex-col py-10 sm:py-12 md:py-16">
      <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col">
        ...
        <div className="mt-6 flex h-[65vh] min-h-[420px] flex-col overflow-hidden rounded-2xl border border-border bg-surface sm:h-[600px]">
          <div ref={scrollAreaRef} className="flex-1 space-y-5 overflow-y-auto p-4 sm:p-5">
            {messages.map((m, i) => (
