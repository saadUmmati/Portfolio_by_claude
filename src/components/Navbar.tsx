      ...
      <header className="sticky top-4 z-50 px-4">
        <div className="mx-auto grid max-w-5xl grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-3">
          ...
          <button
            ...
            className="liquid-glass-light cursor-hover flex items-center gap-2.5 rounded-full py-1.5 pr-4 pl-1.5 text-sm text-foreground/90 transition-transform hover:scale-[1.03]"
          >
